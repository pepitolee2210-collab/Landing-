  ...
  return (
    <span className="inline-flex items-center gap-2.5">
      ...
      >
        ...
        <circle cx="16" cy="16" r="2" fill="var(--color-amber)" />
        {/* Líneas decorativas */}
        <path d="M16 9V14" stroke="var(--color-cyan)" strokeWidth="0.8" strokeOpacity="0.7" />
        <path d="M16 18V23" stroke="var(--color-cyan)" strokeWidth="0.8" strokeOpacity="0.7" />
      </svg>
      <span
        className="font-display font-medium tracking-tight text-[var(--color-text)]"
        style={{ fontSize: small ? 15 : 17, lineHeight: 1 }}
      >
        UsaLatino<span className="text-[var(--color-cyan)]">.</span>Prime
      </span>
    </span>
  )
}
